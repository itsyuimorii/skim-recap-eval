...
export const FIXTURES: Fixture[] = [
  {
    ...
    source: {
      ...
      licence:
        "blog.sshh.io — personal blog, no licence stated; treat as all rights reserved until confirmed.",
    },
  ...
  },
  {
    ...
    source: {
      ...
      extensionVersion: "0.4.0",
      licence:
        "shanahanonliteracy.com — personal blog, no licence stated; treat as all rights reserved until confirmed.",
    },
  ...
  },
  {
    ...
    source: {
      ...
      extensionVersion: "0.4.0",
      licence:
        "arXiv 2605.20706 — check the paper licence; the default arXiv licence does not grant third-party redistribution.",
    },
  ...
  },
  {
    ...
    targetLang: "",
    modes: ["recap", "feynman"],
    undefinedTerms: ["q4_k_m", "q1_0", "\u{1D458} -means", "tok/s", "KV-cache depth"],
    definedInPassage: [
  ...
  },
  {
    ...
    source: {
      ...
      extensionVersion: "0.4.0",
      licence:
        "PMC12472979 — verify the article licence before publishing this text.",
    },
